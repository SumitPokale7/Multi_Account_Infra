...
inputs = {
  ...
  vpc_name   = "TeamCity_VPC"

  private_subnets = [
    { cidr = "172.30.1.0/24", az = "us-east-2a", purpose = "tgw" },
    { cidr = "172.30.2.0/24", az = "us-east-2b", purpose = "db" },
    { cidr = "172.30.3.0/24", az = "us-east-2a", purpose = "db" }
  ]
